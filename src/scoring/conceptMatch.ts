  ...
  return repos
    .flatMap((r) => {
      ...
      return [
        ...
        hasA11yTopic || hasA11yScore ? "accessibility fundamentals wcag axe" : "",
        r.hasCssModules ? "utility-first css" : "",
        r.hasCi ? "git workflow" : "",
        r.hasCi ? "ci cd deployment pipeline github actions" : "",
        r.topics.some((t) => t.includes("docker") || t.includes("kubernetes") || t.includes("container")) ? "docker container orchestration kubernetes" : "",
